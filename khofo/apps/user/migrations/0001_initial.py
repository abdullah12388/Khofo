    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_on', models.DateTimeField(auto_now=True, verbose_name='modified_on')),
                ('is_trashed', models.BooleanField(default=False)),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Country', verbose_name='country')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
                'verbose_name': 'BuyerUserDetails',
                'verbose_name_plural': 'BuyerUserDetails',
            },
        ),
    ]
